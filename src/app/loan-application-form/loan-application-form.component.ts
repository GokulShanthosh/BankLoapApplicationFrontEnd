...
export class LoanApplicationFormComponent implements OnInit {
  ...
  setLoanTitle() {
    ...
    this.loanTitle =
      titles[this.loanType as keyof typeof titles] || 'Loan Application';
  ...
  initializeForm() {
    ...
    if (this.loanType === 'personal') {
      formConfig.loanDetails.addControl(
        'loanPurpose',
      ...
      formConfig.loanDetails.addControl(
        'collateralValue',
        new FormControl('', [Validators.required, Validators.min(10000)])
      );
      formConfig.loanDetails.addControl(
        'collateralDescription',
        new FormControl('', Validators.required)
      );
      formConfig.documentUploads.addControl(
        'collateralDocument',
        new FormControl('', Validators.required)
      );
    }
  ...
  get personalDetails() {
    return this.loanForm.get('personalDetails') as FormGroup;
  }
  get bankDetails() {
    return this.loanForm.get('bankDetails') as FormGroup;
  }
  get loanDetails() {
    return this.loanForm.get('loanDetails') as FormGroup;
  }
  get documentUploads() {
    return this.loanForm.get('documentUploads') as FormGroup;
  }
  ...
  reviewApplication() {
    ...
    if (this.loanForm.valid) {
      ...
      if (this.incomeProofFile)
        formData.append('incomeProofFile', this.incomeProofFile);
      if (this.requiresCollateral && this.collateralDocFile)
        formData.append('collateralDocFile', this.collateralDocFile);
